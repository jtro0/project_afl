...
$FUZZER/afl-fuzz -i /home/ubuntu/project_afl/tests/temp/targets/libpng/corpus/ -o /home/ubuntu/project_afl/tests/temp/targets/libpng/out_afl -j ../output.txt -- $OUT/afl/libpng_read_fuzzer